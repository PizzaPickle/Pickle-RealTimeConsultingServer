...
function updateCameraButton() {
	...
	if (videoTrack) {
		...
		cameraBtn.innerHTML = cameraOff ? '<i class="fas fa-video-slash"></i>' : '<i class="fas fa-video"></i>';
	}
}
...
function updateShareScreenButton() {
	if (isPeerScreenSharing) {
		...
		shareScreenBtn.title = isScreenSharing ? '화면 공유 중지' : '화면 공유 시작';
	}
}
/**
...
function toggleChat() {
	...
	chatToggle.innerHTML = isChatVisible ? '<i class="fas fa-times"></i>' : '<i class="fas fa-comments"></i>';
